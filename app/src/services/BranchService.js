...
const mockBranches = {
    '1': [
        { nome: 'main', ultimoCommit: '2024-12-19', autor: 'João Silva', hash: 'a1b2c3d' },
        { nome: 'develop', ultimoCommit: '2024-12-18', autor: 'Maria Santos', hash: 'e4f5g6h' },
        { nome: 'feature/login', ultimoCommit: '2024-12-17', autor: 'João Silva', hash: 'i7j8k9l' }
    ],
    '2': [
        { nome: 'main', ultimoCommit: '2024-12-18', autor: 'Maria Santos', hash: 'm1n2o3p' },
        { nome: 'develop', ultimoCommit: '2024-12-16', autor: 'João Silva', hash: 'q4r5s6t' }
    ],
    '3': [
        { nome: 'main', ultimoCommit: '2024-12-20', autor: 'João Silva', hash: 'u7v8w9x' },
        { nome: 'develop', ultimoCommit: '2024-12-19', autor: 'Maria Santos', hash: 'y1z2a3b' },
        { nome: 'feature/dashboard', ultimoCommit: '2024-12-18', autor: 'João Silva', hash: 'c4d5e6f' },
        { nome: 'feature/charts', ultimoCommit: '2024-12-17', autor: 'Maria Santos', hash: 'g7h8i9j' }
    ]
};
